 ...
 */
export const nameDescSchema = baseNameDescSchema.extend({
  name: baseNameDescSchema.shape.name.describe("The name of the item."),
  description: baseNameDescSchema.shape.description.describe("A detailed description of the item in at least 5 sentences."),
}).passthrough();
 ...
 */
export const businessProcessSchema = baseNameDescSchema.extend({
  ...
  description: baseNameDescSchema.shape.description.describe("A detailed description of the business process in at least 5 sentences."),
 ...
 */
export const aggregateSchema = baseNameDescSchema.extend({
 ...
 */
export const repositorySchema = baseNameDescSchema.extend({
  name: baseNameDescSchema.shape.name.describe(
 ...
 */
export const entitySchema = baseNameDescSchema.extend({
  name: baseNameDescSchema.shape.name.describe("The name of the domain-driven design entity."),
  description: baseNameDescSchema.shape.description.describe("A detailed description of the entity in at least 5 sentences."),
  relatedEntities: z
    .array(z.string())
    .describe(
 ...
 */
export const potentialMicroserviceSchema = baseNameDescSchema.extend({
