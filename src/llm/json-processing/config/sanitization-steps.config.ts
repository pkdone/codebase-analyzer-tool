...
export const SANITIZATION_STEP = Object.freeze({
  ...
  FIXED_STRAY_TEXT_BEFORE_UNQUOTED_PROPERTIES:
  ...
  REMOVED_STRAY_LINES_BETWEEN_STRUCTURES: "Removed stray lines between JSON structures",
  ...
  FIXED_MISSING_QUOTES_AROUND_PROPERTY_VALUES:
    "Fixed missing quotes around property values",
