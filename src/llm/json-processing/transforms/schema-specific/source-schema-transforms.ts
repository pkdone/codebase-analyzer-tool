/**
 * Schema-specific post-parse transformations for the sourceSummarySchema.
 * These transformations are aware of the sourceSummarySchema structure and
 * fix common issues in LLM responses that target this specific schema.
 */
