 ...
 * These constants are tied to the sourceSummarySchema structure and should not be used
 * in generic, schema-agnostic sanitizers. However, they are kept here for sanitizers
 * that need to fix truncated property names, typos, and other schema-specific issues.
 *
 * TODO: Consider moving this to a more appropriate location or making the sanitizer
 * accept these as configuration parameters.
 */
