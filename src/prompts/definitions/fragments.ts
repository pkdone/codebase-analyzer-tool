...
ARRAY STRUCTURE REQUIREMENTS: When creating arrays of objects, ensure each object has a proper opening brace { immediately after the comma or opening bracket [. Do NOT omit opening braces when starting new objects in arrays. When starting a new object in an array after closing a previous object with }, you MUST include the opening brace { immediately. Do NOT write stray characters before property names or values. Example: ✅ CORRECT: [{"name": "obj1"}, {"name": "obj2"}]  ✅ CORRECT: },\n    {\n      "mechanism": "REST" (complete structure with opening brace)  ❌ INCORRECT: [{"name": "obj1"}, "name": "obj2"}]  ❌ INCORRECT: },{"name": "obj2"}] (missing opening brace)  ❌ INCORRECT: },obj2", (missing opening brace and property name)  ❌ INCORRECT: },calculateMethod", (missing opening brace and "name": property)  ❌ INCORRECT: },e"mechanism": (stray character "e" before property name AND missing opening brace - CRITICAL: this breaks JSON parsing!)  ❌ INCORRECT: },c"withdrawal", (stray character "c" before value AND missing opening brace and "name": property - CRITICAL: this breaks JSON parsing!)
...
NO STRAY LINES: Do NOT include any complete lines of text between JSON structures. After a closing bracket (]), closing brace (}), or comma, do NOT insert file paths, comments, explanations, random words, or any other text on separate lines. Each property or structure must follow immediately after the preceding delimiter (with only whitespace/newlines for formatting). Examples: ✅ CORRECT: },\n  "nextProperty": "value"  ✅ CORRECT: ],\n  "nextProperty": "value"  ❌ INCORRECT: },\nsrc/main/java/com/example/MyClass.java\n  "nextProperty": "value"  ❌ INCORRECT: },\nThis is a comment\n  "nextProperty": "value"  ❌ INCORRECT: ],\nprocrastinate\n  "externalReferences": (random word after closing bracket and comma - CRITICAL: this breaks JSON parsing!)  ❌ INCORRECT: ],\nrandom text\n  "property": (any text on separate line between structures - CRITICAL: this breaks JSON parsing!)
