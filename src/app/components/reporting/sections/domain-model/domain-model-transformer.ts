...
/**
 * Transformer for domain model data.
 * Transforms hierarchical bounded contexts data into a flattened structure
 * suitable for reporting and diagram generation.
 *
 * Note: This class transforms data that is already in memory, rather than
 * fetching it from a repository. The "Transformer" name clarifies this
 * pure transformation role.
 */
@injectable()
export class DomainModelTransformer {
  /**
