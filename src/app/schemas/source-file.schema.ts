/**
 * Source file schema module - consolidated schema, enums, and constants.
 *
 * This module provides:
 * - Re-exported schema value enumerations (from constants module)
 * - MongoDB field path constants
 * - Zod schemas for source file validation
 *
 * All source-related definitions are co-located here for better maintainability.
 */
...
// Re-export schema value constants from the dedicated constants module.
// This maintains backwards compatibility while decoupling prompts from this heavy schema file.
export {
...
// =============================================================================
// MONGODB FIELD CONSTANTS - Field paths for queries and indexes
// =============================================================================
...
// =============================================================================
// ZOD SCHEMAS - Validation schemas for source file data
// =============================================================================
