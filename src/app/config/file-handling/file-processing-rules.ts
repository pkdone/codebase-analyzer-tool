...
export const fileProcessingRules = {
  ...
  /**
   * File suffix patterns that indicate minified files.
   * These files are skipped entirely during capture.
   */
  ...
  /**
   * File suffix patterns that indicate generated files.
   * These files are skipped entirely during capture.
   */
  ...
  /**
   * Marker strings found in the first 1024 characters of generated files.
   * If any marker is present in the file header, the file is skipped during capture.
   */
