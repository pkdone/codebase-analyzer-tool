 ...
 * - LLM metadata property rules: Handle extra_*, _llm_*, _ai_* patterns
...
export { LLM_METADATA_PROPERTY_RULES } from "./llm-metadata-property-rules";
 ...
 * 3. LLM metadata property rules - Remove extra_*, _llm_*, _ai_* patterns
