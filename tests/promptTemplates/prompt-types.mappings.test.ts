...
describe("prompt.types fileTypesToCanonicalMappings", () => {
  describe("FILE_EXTENSION_TO_CANONICAL_TYPE_MAPPINGS", () => {
    it("should have readonly map of file extensions to canonical types", () => {
      ...
      expect(
        fileTypesToCanonicalMappings.FILE_EXTENSION_TO_CANONICAL_TYPE_MAPPINGS instanceof Map,
      ).toBe(true);
    });
  ...
  describe("FILENAME_TO_CANONICAL_TYPE_MAPPINGS", () => {
    it("should have readonly map of filenames to canonical types", () => {
      expect(fileTypesToCanonicalMappings.FILENAME_TO_CANONICAL_TYPE_MAPPINGS).toBeDefined();
      expect(fileTypesToCanonicalMappings.FILENAME_TO_CANONICAL_TYPE_MAPPINGS instanceof Map).toBe(
        true,
      );
    });

    it("should map common documentation filenames to markdown", () => {
      const map = fileTypesToCanonicalMappings.FILENAME_TO_CANONICAL_TYPE_MAPPINGS;
