    ...
    "org.apache.fineract.portfolio.loanproduct.data.TransactionProcessingStrategyData"
      ...
      const config = {
        packageNameTypoPatterns: [
          {
            pattern: /orgapache\./g,
            replacement: "org.apache.",
            description: "Fix orgapache typo",
          },
        ],
      };
      const result = unifiedSyntaxSanitizer(input, config);
...
b  "publicFunctions": []
  ...
  "type": a"boolean"
    ...
    // Test removed: stray character before numeric property value
    // This feature requires domain-specific config provided at application level
  });
  ...
  "internalReferences": [
    "orgah.apache.fineract.client.models.PostClientsRequest"
      ...
      const config = {
        packageNameTypoPatterns: [
          {
            pattern: /orgah\.apache/g,
            replacement: "org.apache",
            description: "Fix orgah.apache typo",
          },
        ],
      };
      const result = unifiedSyntaxSanitizer(input, config);
        ...
        packageNameTypoPatterns: [
          {
            ...
            description: "Fix org.apachefineract missing dot",
          },
        ],
      };
      const result = unifiedSyntaxSanitizer(input, config);
        ...
        packageNameTypoPatterns: [
          {
            ...
            replacement: "org.apache.fineract.",
            description: "Fix orgfineract missing package",
          },
        ],
      };
      const result = unifiedSyntaxSanitizer(input, config);
